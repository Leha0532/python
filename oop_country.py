...
c2 = Country("папаская область(ватикан)", 500,3000000,"italy",665)      
...
class Microstate(Country):
    def __init__(self, name: str, gdp: int, leader: str, population: int):
        super().__init__(name, gdp, 0, leader, population)
